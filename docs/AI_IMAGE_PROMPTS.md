...
```text
Extreme foreground layer for a rain-night game scene, meant to be overlaid with depth-of-field blur. Dark out-of-focus shapes at the frame edges only: a blurred wet stone ledge at bottom-left, a hanging hemp rope at top-right, dense diagonal rain streaks catching faint cold light (#9fc4e8). The CENTER of the image must remain EMPTY and dark (#0b1a2b) so the scene behind stays visible. Painterly cinematic photorealistic texture, heavy motion-blurred rain, deep cold blue palette, cinematic. Style: cinematic photorealistic overlay art, muted rain-night palette (#0b1a2b, #16324a), heavy vignette at edges, NOT flat illustration, NOT anime, NOT 3D render, no text, no watermark.
```
...
```text
Side silhouette of a small wooden ferry boat on black water, one curved prow, a single oar resting across the gunwale, thin cold mist around the hull, no figures, no lights. Deep cold blue palette (#0b1a2b water, #16324a mist, #9fc4e8 faint edge highlight along the hull). Solid dark blue background (#0b1a2b) merging with the water for easy cutout. Style: cinematic photorealistic prop texture, muted rain-night palette, heavy vignette, cinematic, quiet and final. NOT flat illustration, NOT anime, NOT 3D render, no warm light, no text, no watermark.
```
...
```text
One small worn child's cloth shoe lying on its side, faded red fabric dulled to rust tones (#a8532f) by years and river water, sole slightly separated, heavy emotional weight, dim warm amber light from one side (#ffb15c) as if from a soup bowl far away, everything else deep cold blue (#0b1a2b). Solid dark blue background. Style: cinematic photorealistic prop texture, muted rain-night palette, heavy vignette, cinematic, devastatingly quiet. NOT flat illustration, NOT anime, NOT 3D render, no text, no watermark.
```
...
```text
An abstract floating shard of amber light (#d8a24a), shaped like a broken piece of memory — irregular crystal edges, glowing softly from inside, thin cracks of darker rust red (#a8532f) running through it, tiny particles drifting off its edges. No background context, the shard floats alone. Solid dark blue background (#0b1a2b) for clean cutout. Style: cinematic photorealistic effect texture, muted rain-night palette, ethereal glow, heavy vignette. NOT flat illustration, NOT anime, NOT 3D render, no text, no watermark.
```
...
```text
Abstract memory fragment: a single bowl of noodles left untouched in a dark corner of a noodle shop, the steam risen into ghostly pale gold wisps (#c9b08a), warm amber afterglow around the bowl (#d8a24a), loneliness rendered as light, everything else dissolved into deep cold blue (#0b1a2b), cinematic and grainy. Solid dark blue background (#0b1a2b) for clean cutout. Style: cinematic photorealistic effect texture, muted rain-night palette, ethereal glow, heavy vignette. NOT flat illustration, NOT anime, NOT 3D render, no text, no watermark.
```
